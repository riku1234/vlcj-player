...
public final class MainFrame extends BaseFrame {
    ...
    private final Action RTPOpenAction;
    ...
    public MainFrame() {
        ...
        RTPOpenAction = new StandardAction(resource("menu.media.item.openRTP")) {
            @Override
            public void actionPerformed(ActionEvent e) {
                String mrl = "file:///Users/gsm/Documents/file.sdp";
                System.out.println("Playing RTP Stream.");
                mediaPlayerComponent.getMediaPlayer().playMedia(mrl);
            }
        };
        ...
        mediaMenu.add(new JMenuItem("Random"));
        System.out.println("Adding RTP Open Menu Item.");
        mediaMenu.add(new JMenuItem(RTPOpenAction));
